...
<li className={`${user ? "pt-10" : "pt-5"} `}>
  <Link  className={`${pathname === '/addproduct' ? 'active-link' : ''}`} style={{style:""}} to="/addproduct">Add Product</Link>
</li>

<li className={`${user ? "pt-10" : "pt-5"} `}>
  <Link className={`${pathname === '/mycart' ? 'active-link' : ''}`} to="/mycart">My Cart</Link>
</li>
...
<li className={`${user ? "pt-10" : "pt-5"} `}>
  {user?.displayName ? (
    ...
    <Link  className={`${pathname === '/login' ? 'active-link' : ''}`} to="/login">
      <p className="border-0">Log in</p>
    </Link>
  )}
</li>
              ...
              <img
                ...
                src={` ${
                  theme === "light"
                    ...
                    : "https://i.ibb.co/xYnRrrK/electro-for-dark2-removebg-preview.png"
                }`}
              />
            </div>
          </a>
