      ...
      <div className="navbar  lg:max-w-6xl mx-auto   ">
        <div className="navbar-start">
          ...
          <a className="mt-10     ">
            ...
            <img className="w-full " src={` ${theme==="light"?"https://i.ibb.co/RHwMJBk/electrologo-removebg-preview.png":"https://i.ibb.co/xYnRrrK/electro-for-dark2-removebg-preview.png"}`}  />
